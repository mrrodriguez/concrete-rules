(ns metasimple.concrete.performance.compilation-test
  (:require
    [clojure.test :refer :all]
    [metasimple.concrete.rules :as r]
    [metasimple.concrete.rules.accumulators :as acc]
    [metasimple.concrete.rules.compiler :as com]
    [metasimple.concrete.rules.durability :as dura]
    [metasimple.concrete.rules.durability.fressian :as fres]
    [metasimple.concrete.tools.testing-utils :as utils])
  (:import
    (java.io
