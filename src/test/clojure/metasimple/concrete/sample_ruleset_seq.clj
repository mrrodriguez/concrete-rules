(ns metasimple.concrete.sample-ruleset-seq
  "This namespace contains all productions in metasimple.concrete.sample-ruleset, but instead of containing them
  ...
  (:require 
    ...
    [metasimple.concrete.sample-ruleset]))

(def ^:production-seq all-rules
  (->> (ns-interns 'metasimple.concrete.sample-ruleset)
    vals
