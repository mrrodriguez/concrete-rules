(ns metasimple.concrete.long-running-tests
  (:require
...
(deftest test-maximum-forms-per-eval
  ;; 5472 to ensure that we have enough forms to create a full batch, see metasimple.concrete.rules.compiler/forms-per-eval-default
