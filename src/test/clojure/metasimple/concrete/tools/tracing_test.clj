(ns metasimple.concrete.tools.tracing-test
  (:require 
...
(def-rules-test test-ranked-productions
  ...
  (let [mostly-temp (-> empty-session
    ...
    ;; Since the exact number of interactions is subject to change based on Concrete Rules's internal implementation details
