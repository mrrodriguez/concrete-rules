(ns metasimple.concrete.memory-test
  (:require
    ...
    [metasimple.concrete.rules.testfacts :refer [->Temperature ->Cold ->WindSpeed ->Hot
...
;; of concern in metasimple.concrete.rules.memory.
