(ns metasimple.concrete.rules-require-test
  (:require 
            [metasimple.concrete.rules.compiler :as com]
    [clojure.test :refer [is deftest run-tests testing use-fixtures]]
    [metasimple.concrete.rule-defs :as rd]
    [metasimple.concrete.rules :refer [insert fire-rules query defsession]]
    [metasimple.concrete.rules.testfacts :as facts]
...
(defsession my-session 'metasimple.concrete.rule-defs)
