...
/**
 * Concrete Rules rule loader. Produces a {@link WorkingMemory WorkingMemory} given one or more Clojure
...
public class RuleLoader {
    ...
    /**
     * Function to make a new Concrete Rules session.
     */
    static final IFn makeSession;

    static {

        require.invoke(Symbol.intern("metasimple.concrete.rules.java"));

        makeSession = RT.var("metasimple.concrete.rules.java", "mk-java-session");
    }
