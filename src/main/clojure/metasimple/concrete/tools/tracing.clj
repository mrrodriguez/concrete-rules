(ns metasimple.concrete.tools.tracing
...
(defn- to-tracing-listener
  [^PersistentTracingListener listener]
...
(defn ranked-productions
  ...
  amount of times Concrete Rules performed processing related to this rule.  This
  ...
  the results may change between different versions when Concrete Rules's internals change,
